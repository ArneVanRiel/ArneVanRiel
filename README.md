...
Met een sterke professionele achtergrond als calculator in complexe openbare aanbestedingen en waterwerken, ben ik gewend om uiterst gestructureerd te werken, kritisch te denken en grote hoeveelheden cijfers om te zetten in kloppende resultaten. Die passie voor logica, precisie en optimalisatie pas ik nu toe in softwareontwikkeling.

Ik richt mij op het bouwen van robuuste, data-gedreven webapplicaties, met een scherpe focus op sterke backend-architectuur, datamodellering en naadloze API-integraties.
...
*   **Database:** SQL Server
*   **Hosting & Tools:** Git, Vercel, Render, JWT Authentication
